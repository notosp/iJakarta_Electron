...
import Sidebar from "./sidebar-koleksi";
...
class Layouts extends React.Component {
  ...
  fetchMoreData = () => {
    ...
    setTimeout(() => {
      axios
        .get(
          `${base_api}/books/sort/${this.state.parameter}?client_id=${client_id}&category_id=${Router.query.kategori_id}&per_page=12&page=${this.state.page}`
        )
        .then(res => {
